function delay_n = sgmfsk_filter_series(BW,fs,BR,fs_rx,g_TBW,g_span,g_sps,F_dev)
    ...
    switch BW
        case 1e3
            ...
            filt_dec_dly(1) = grpdelay(FLT.DEC_stage1,1)/fs_in1;
            filt_dec_dly(2) = grpdelay(FLT.DEC_stage2,1)/fs_in2;
            filt_dec_dly(3) = grpdelay(FLT.DEC_stage3,1)/fs_in3;
            filt_dec_dly(4) = grpdelay(FLT.DEC_stage4,1)/fs_in4;
    end
    ...
    switch BW
        case 1e3
            ...
            filt_dec_dly(5) = grpdelay(FLT.DEC_stage5,1)/fs_hbFilt;
